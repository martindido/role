...
export default (
    action$: ActionsObservable<SignUpConfirmSyncAction | SignUpConfirmSuccessAction | SignUpConfirmErrorAction>
) =>
    action$.ofType<SignUpConfirmSyncAction>(SIGN_UP_CONFIRM_SYNC).pipe(
        mergeMap((signUpConfirmSyncAction) =>
            action$
                .ofType<SignUpConfirmSuccessAction | SignUpConfirmErrorAction>(
